...
`2.2.0`. Post-cut status lives in `docs/EVOLUTION.md`. Operator use:
`docs/MANUAL.md`.
...
See `docs/EVOLUTION.md`. P11–P14 shipped in `2.2.0`; the 12-view screenshot
gallery and walkthrough are recaptured, so nothing is outstanding.
