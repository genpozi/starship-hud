...
**Version:** `2.2.0` (Phase 1–10 + P11–P14 on this branch). Branch of record
for the 2.2.0 cut: `260909-feat-comms-depth-hud-interact`. PR:
...
| `docs/EVOLUTION.md` | P11–P14 (P14 filesystem vault DONE) |
